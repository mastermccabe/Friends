...
VALUES ('Diana', 'Smith', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
###
SELECT users2.first_name as friend_first_name, users2.last_name as friend_last_name, users.first_name as users_first_name, users.last_name as user_last_name  FROM users
...
/* 1 - Chris Baker 
  ...
  3 - james johnson
  4 - diana smith
  DELETE FROM `mydb`.`users` WHERE `id`='5';

*/
SELECT * FROM users u
LEFT JOIN friendships f ON u.id=f.id
LEFT JOIN users as user2 ON 1 = 2
